...
TEST(CSVCacheIOManagerTest, no_matching_files_returns_empty)
{
    TempCacheFile temp{"no_match", "csv"};
...
TEST(CSVCacheIOManagerTest, single_file_empty_result_roundtrip)
{
    TempCacheFile temp{"single_empty", "csv"};
    const CSVCacheIOManager manager{temp.m_folder};
...
TEST(CSVCacheIOManagerTest, single_file_nonempty_result_roundtrip)
{
    TempCacheFile temp{"single_nonempty", "csv"};
    const CSVCacheIOManager manager{temp.m_folder};
...
TEST(CSVCacheIOManagerTest, category_merges_two_graphs_first_empty_second_nonempty)
{
    TempCacheCategory temp{"two_graphs_first_empty", "csv"};
    const CSVCacheIOManager manager{temp.m_folder};
...
TEST(CSVCacheIOManagerTest, category_merges_two_graphs_both_nonempty)
{
    TempCacheCategory temp{"two_graphs_both_nonempty", "csv"};
    const CSVCacheIOManager manager{temp.m_folder};
