#include "patterns/pattern_finders/MultiGraphPatternFinder.h"
...
class MultiGraphPatternFinderTest : public ::testing::Test
{
protected:
    /**
...
/**
 * @brief find_pattern on a single empty graph throws.
 */
TEST_F(MultiGraphPatternFinderTest, find_pattern_single_empty_graph_throws)
{
    std::vector<ColoredGraph> graphs;
    graphs.push_back(make_empty_graph());

    MultiGraphPatternFinder finder(graphs, false, null_logger());

    EXPECT_THROW(finder.find_pattern(0.5), std::runtime_error);
}

/**
 * @brief find_pattern on a single path-4 graph returns a pattern isomorphic to the input
 *        and keeps graph 0 alive.
 */
TEST_F(MultiGraphPatternFinderTest, path_4_one_graph_found_graph)
{
...
TEST_F(MultiGraphPatternFinderTest, path_4_colored_one_graph_found_graph)
{
...
TEST_F(MultiGraphPatternFinderTest, path_4_directed_colored_one_graph_found_graph)
{
...
TEST_F(MultiGraphPatternFinderTest, triangle_3_one_graph_found_graph)
{
...
TEST_F(MultiGraphPatternFinderTest, triangle_3_directed_one_graph_found_graph)
{
...
TEST_F(MultiGraphPatternFinderTest, triangle_3_colored_one_graph_found_graph)
{
...
TEST_F(MultiGraphPatternFinderTest, triangle_3_colored_directed_one_graph_found_graph)
{
...
TEST_F(MultiGraphPatternFinderTest, star_5_one_graph_found_graph)
{
...
TEST_F(MultiGraphPatternFinderTest, complex_graph_one_graph_found_graph)
{
    const GraphSpec spec = complex_graph();
    std::vector<ColoredGraph> graphs;
    graphs.push_back(spec.to_graph());
...
TEST_F(MultiGraphPatternFinderTest, complex_graph_directed_one_graph_found_graph)
{
    const GraphSpec spec = complex_graph_directed();
    std::vector<ColoredGraph> graphs;
    graphs.push_back(spec.to_graph());
...
TEST_F(MultiGraphPatternFinderTest, complex_graph_colored_one_graph_found_graph)
{
    const GraphSpec spec = complex_graph_colored();
    std::vector<ColoredGraph> graphs;
    graphs.push_back(spec.to_graph());
...
TEST_F(MultiGraphPatternFinderTest, complex_graph_colored_directed_one_graph_found_graph)
{
    const GraphSpec spec = complex_graph_colored_directed();
    std::vector<ColoredGraph> graphs;
    graphs.push_back(spec.to_graph());
...
TEST_F(MultiGraphPatternFinderTest, path_4_with_added_vertex_3_graphs_found_graph)
{
    const GraphSpec spec = make_path_4_with_1_added_vertex();
    std::vector<ColoredGraph> graphs;
    graphs.push_back(spec.to_graph());
    graphs.push_back(make_path_4().to_graph());
