...
{
    std::vector<uint32_t> neighbour_indeces = is_reversed && m_directed ? m_reversed_index_of_neighbours : m_index_of_neighbours;
    uint32_t end_neighbour = vertex + 1U < neighbour_indeces.size() ? neighbour_indeces.at(vertex + 1U) : 
